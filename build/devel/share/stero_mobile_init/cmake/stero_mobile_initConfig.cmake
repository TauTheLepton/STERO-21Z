...
if("TRUE" STREQUAL "TRUE")
  set(stero_mobile_init_SOURCE_PREFIX /home/tiago/mobile_ws/src/stero_mobile)
  set(stero_mobile_init_DEVEL_PREFIX /home/tiago/mobile_ws/src/stero_mobile/build/devel)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'DO-UZUPELNIENIA!!!! <DO-UZUPELNIENIA@mail.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'stero_mobile_init' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tiago/mobile_ws/src/stero_mobile/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/tiago/mobile_ws/src/stero_mobile/build/devel/lib;/opt/ros/melodic/lib)
...
set(stero_mobile_init_EXPORTED_TARGETS "")
